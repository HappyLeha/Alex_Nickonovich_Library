use library;
insert into authors values('Herbert','Schildt',null,'MAN',null);
insert into publishings values('Russia','St.Peterburg',null,null);
insert into books values('Java the complete reference',2013,'St.Peterburg',null,1,null),('Philosophy of java',2011,null,null,2,null);
